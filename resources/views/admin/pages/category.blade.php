    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                <button type="submit" class="btn btn-primary btn-round text-uppercase btn-add-category" data-bs-toggle="modal"
                    data-bs-target="#add-category"><i class="fas fa-plus me-2"></i>Thêm danh mục</button>
                <button type="submit" class="btn btn-primary btn-round text-uppercase btn-add-sub-category"
                    data-bs-toggle="modal" data-bs-target="#add-sub-category"><i class="fas fa-plus me-2"></i>Thêm loại</button>
                <button type="submit" class="btn btn-primary btn-round text-uppercase btn-add-subsub-category"
                    data-bs-toggle="modal" data-bs-target="#add-subsub-category"><i class="fas fa-plus me-2"></i>Thêm kiểu</button>
            </div>
        </div>
        <div class="row">
            ...
            function loadTable() {
                $.ajax({
                    ...
                    success: function(response) {
                        let tableBody = $('#add-row tbody');
                        tableBody.empty(); // Xoá dữ liệu cũ
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-button-action">
                                        ...
                                        <button type="button" data-bs-toggle="tooltip" title="Remove" class="btn btn-link btn-danger btn-delete-account" data-id='${item.id}'>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            loadTable(); // hoặc chỉ update lại dòng dữ liệu
                        });
                    },
                    error: function(xhr) {
                        if (xhr.status === 422) {
