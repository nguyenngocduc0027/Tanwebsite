            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-cus-30 footer-info">
                    <div class="logo-footer">
                        <a href="index.html" title="Sudes Nest">
                            <img width="300" height="96"
                                src="/images/logo/logo.webp"
                                alt="Sudes Nest" class="">
                        </a>
                    </div>
                    ...
                    <div class="social-footer">
                        <div class="social">
                            ...
                            <a href="https://facebook.com/" target="_blank" aria-label="Facebook"
                                title="Theo dõi Sudes Nest trên Facebook">
                                <img class="" width=35 height=35 alt="Facebook"
                            ...
                            <a href="https://www.instagram.com/" target="_blank" aria-label="Instagram"
                                title="Theo dõi Sudes Nest trên Instagram">
                            ...
                            <a href="https://shopee.vn/" target="_blank" aria-label="Shopee"
                                title="Theo dõi Sudes Nest trên Shopee">
                                <img class="" width=35 height=35 alt="Shopee"
                                    data-src="//bizweb.dktcdn.net/100/506/650/themes/944598/assets/shopee.svg?1739018973665"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" />
                            </a>


                            <a href="https://www.lazada.vn/" target="_blank" aria-label="Lazada"
                                title="Theo dõi Sudes Nest trên Lazada">
                                <img class="" width=35 height=35 alt="Lazada"
                                    data-src="//bizweb.dktcdn.net/100/506/650/themes/944598/assets/lazada.svg?1739018973665"
                                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" />
                            </a>


                            <a href="https://www.tiktok.com/vi-VN" target="_blank" aria-label="Tiktok"
                                title="Theo dõi Sudes Nest trên Tiktok">
                                <img class="" width=35 height=35 alt="Tiktok"
                ...
                <div class="col-xs-12 col-md-4 col-lg-cus-20 footer-click">
                    ...
                    <ul class="list-menu toggle-mn hidden-mob">
                        ...
                        <li class="li_menu">
                            <a href="cam-ket-cua-hang.html" title="Cam kết cửa hàng">Cam kết cửa hàng</a>
                        </li>
                ...
                <div class="col-xs-12 col-md-4 col-lg-cus-20 footer-click">
                    ...
                    <ul class="list-menu toggle-mn hidden-mob footer-click">
                        ...
                        <li class="li_menu">
                            <a href="quy-dinh-bao-hanh.html" title="Quy định bảo hành">Quy định bảo hành</a>
                        </li>

                        <li class="li_menu">
                            <a href="huong-dan-chuyen-khoan.html" title="Hướng dẫn chuyển khoản">Hướng dẫn chuyển
                                khoản</a>
                        </li>
                    ...
                    <div class="block-payment">
                        ...
                        <div class="payment-footer list-menu">
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="MoMo"
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="Zalo Pay"
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="VnPay"
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="Moca"
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="Visa"
                            ...
                            <div class="payment-item">
                                <img class="" width=126 height=58 alt="ATM"
