                ...
                <div class="col-lg-9 header-promo">
                    ...
                    <ul class="ul-default promo-list js-promo">
                        ...
                        <li class="promo-item  see-none">
                            <a class="duration-300 line-clamp-2-new" href="#"
                                title="Khuyến mãi 30/4 - 1/5  hấp dẫn nhất mua hè này KHÔNG THỂ BỎ LỠ!!!!">Khuyến mãi
                                <span>30/4 - 1/5 hấp dẫn nhất mua hè này</span> KHÔNG THỂ BỎ LỠ!!!!</a>
                        </li>
                        <li class="promo-item  see-none">
                            <a class="duration-300 line-clamp-2-new" href="#"
                ...
                <div class="row align-items-center">
                            ...
                            <form action="#" method="get" class="header-search-form input-group search-bar"
                                ...
                                <div class="search-suggest">
                                    ...
                                    <div class="item-suggest">
                                        ...
                                        <div class="search-list">
                                            <a href="#" class="search-item" title="Tìm kiếm Sản Phẩm">
                                                Sản Phẩm
                                            </a>
                    ...
                    <div class="col-6 col-lg-3 col-md-8 header-right">
                        ...
                        <div class="sudes-header-iwish sm-hidden">
                            <a href="{{route('favorite.index')}}" title="Danh sách yêu thích">
                                <span class="box-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <span class="js-wishlist-count">{{ $wishlistCount }}</span>
                                </span>
                ...
                <ul class="md-hidden list-menu-account">
                    ...
                    <li class="li-account">
                        <a href="{{route('favorite.index')}}" title="Danh sách yêu thích">
                            ...
                            Danh sách Yêu thích <div class="js-wishlist-count">{{ $wishlistCount }}</div>
                        </a>
                    </li>
                    <li class="li-account">
                        <a href="#" title="Cửa hàng">
