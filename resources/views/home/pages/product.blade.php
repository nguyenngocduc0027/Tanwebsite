            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-list-cate">
                        <div class="menu-list">
                            @for ($i = 0; $i < 5; $i++)
                                <a class="cate-item duration-300 " href="#" title="Sản Phẩm {{$i}}">
                                    <div class="cate-info-title">Sản Phẩm {{$i}}</div>
                                </a>
                            @endfor
                        </div>
                    </div>
                    <div class="col-desc">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt earum hic explicabo maiores ex id eligendi, molestiae natus eum, voluptates eaque ratione a blanditiis illum veritatis debitis, non voluptate! Enim?</p>
                    </div>
                </div>
                                        ...
                                        <form action="" method="post"
                                            ...
                                            <div class="tag-promo" title="Quà tặng">
                                                <img src="/images/tag_pro_icon.svg"
                                                    data-src="/images/tag_pro_icon.svg"
                                                    alt="Quà tặng" class="lazyload" />
                                                <div class="promotion-content">
                                                    <div class="line-clamp-5-new" title="- Tặng 1 túi giấy xách đi kèm - 1 Hộp đường phèn">
                                                        <p><span style="letter-spacing: -0.2px;">- Tặng 1 túi giấy xách đi kèm <br>- 1 Hộp đường phèn </span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-info">
                                                <div class="name-price">
                                                    <h3 class="product-name line-clamp-2-new">
                                                        <a href="#"
                                                            title="San Pham So {{ $i }} ">San Pham So {{ $i }} </a>
                                                    </h3>
